...
const SiteHead: FC<ISiteHeadProps> = ({
  ...
  return (
    <Head>
      ...
      <meta property="og:image:url" content={process.env.NEXT_PUBLIC_SITE_URL + '/banner.png' || 'https://cosmoscleaner.com/banner.png'} />
      ...
      <meta name="twitter:image:url" content={process.env.NEXT_PUBLIC_SITE_URL + '/banner.png' || 'https://cosmoscleaner.com/banner.png'} />
