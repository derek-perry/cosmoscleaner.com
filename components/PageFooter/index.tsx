...
const PageFooter = (): JSX.Element => {
  ...
  return (
      <footer className="bg-cyan-900 text-cyan-100 text-xl w-full">
        <div className="pt-14 pb-12 px-9 flex flex-col gap-y-10 text-center items-center justify-center">
          ...
          <div className="flex flex-row flex-wrap gap-x-8 gap-y-2 text-center items-center justify-center">
                <p> © {currentYear} <LinkInternal className="!text-cyan-100 focus:!text-lime-500 hover:!text-sky-500 no-underline" href="" title="Cosmos Cleaner">Cosmos Cleaner</LinkInternal></p>
