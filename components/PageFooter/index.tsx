...
const PageFooter = (): JSX.Element => {
  return (
      <footer className="flex w-full flex-col items-center justify-center border-t">
        ...
        >
          <LinkExternal href="https://cosmoscleaner.com" title="Cosmos Cleaner" className="no-underline"><p>Cosmos Cleaner</p></LinkExternal><p className="pr-2 pl-2"> - </p><LinkExternal href="https://dp.design" title="Derek Perry" className="no-underline"><p>Derek Perry</p></LinkExternal>
