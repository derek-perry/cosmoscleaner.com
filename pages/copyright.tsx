      ...
      <main className="py-9 px-9 max-w-[1100px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="policy">
          ...
          <section id="copyrightlicenseoverview" className="max-w-[800px] text-left">
              ...
              <p className="my-4 text-2xl">The Cosmos Cleaner's <LinkExternal href="https://github.com/derek-perry/CosmosCleaner-Website" title="View Cosmos Cleaner's Website by Derek Perry on GitHub">website code on GitHub</LinkExternal> is licensable under the <LinkExternal href="https://mit.edu/~amini/LICENSE.md" title="View the Official MIT License at mit.edu/~amini/LICENSE.md">MIT License</LinkExternal> starting in 2023 under the sole ownership of <LinkExternal href="https://dp.design" title="Go to Derek Perry's Website at dp.design">Derek Perry</LinkExternal> and the Cosmos Cleaner brand.</p>
              ...
              <p className="my-4 text-2xl"><i>This Copyright/License Overview was last updated on July 20, 2023.</i></p>
