      ...
      <main className="py-20 px-9 max-w-[1250px] w-full flex flex-1 flex-col text-center items-center justify-center">
        ...
        <div className="max-w-[596px] flex flex-wrap items-center align-center justify-center gap-6 mb-20">
          <div className="max-w-[590px] flex flex-col pb-3 px-3 bg-cyan-100 rounded">
            ...
            <p className="text-lg mt-3"><strong>Game Version:</strong> v0.1.0w <em>(See <LinkInternal href="changelog" title="CosmosCleaner.com/changelog">change log</LinkInternal>)</em></p>
            ...
            <ButtonExternal className="text-2xl my-4" href="https://dropbox.com/scl/fi/dsth73rkj7p42wep63k7z/Cosmos-Cleaner-v0.1.0w.zip?rlkey=b45da7y1u0881ge4tt8n986p1&dl=1" title="Download Cosmos Cleaner for Windows 10/11 (64-bit)">Download</ButtonExternal>
