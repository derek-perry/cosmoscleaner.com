...
const playPage: NextPage = () => {
  return (
    <div className="text-cyan-900 min-h-screen flex flex-col items-center justify-center">
      <SiteHead title="Cosmos Cleaner" description="Clean up space junk, upgrade your ship, and become the best cleaner in the cosmos!" url="play" />
      ...
      <main className="py-20 px-9 max-w-[1250px] w-full flex flex-1 flex-col text-center items-center justify-center">
        ...
        <div className="max-w-[596px] flex flex-wrap items-center align-center justify-center gap-6 mb-20">
          <div className="max-w-[590px] flex flex-col pb-3 px-3 bg-cyan-100 rounded">
            ...
            <p className="text-lg mt-3"><strong>Game Version:</strong> v0.0.2w</p>
            ...
            <ButtonExternal className="text-2xl my-4" href="https://dropbox.com/scl/fi/ptwz321thamgkd9ezz4p2/Cosmos-Cleaner-v0.0.2w.zip?rlkey=cmc2psukypp8j0zk32itkicqr&dl=1" title="Download Cosmos Cleaner for Windows 10/11 (64-bit)">Download</ButtonExternal>
