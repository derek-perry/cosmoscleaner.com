          ...
          <section id="changelogs" className="max-w-[1000px] text-left">
            ...
            <h2 id="windows">Windows Releases</h2>
              ...
              <h3 id="012">v0.1.2w</h3>
                ...
                <p><strong>Changes:</strong></p>
                <ul className="text-2xl list-disc pl-8">
                  <li>Added background behind HUD elements for better readability</li>
                  <li>Added a count/progress bar to show remaining clutter on current level/day</li>
                </ul>
              <h3 id="011">v0.1.1w</h3>
