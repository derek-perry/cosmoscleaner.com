      ...
      <main className="py-9 px-9 max-w-[1100px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="policy">
          ...
          <section id="privacypolicy" className="max-w-[800px] text-left">
              ...
              <p className="my-4 text-2xl">If you have any questions about this Privacy Policy, please contact Cosmos Cleaner via email at <LinkExternal href="mailto:contact@cosmoscleaner.com" title="Contact Cosmos Cleaner via Email at Contact@CosmosCleaner.com">Contact@CosmosCleaner.com</LinkExternal></p>
          </section>
        </article>
      </main>
