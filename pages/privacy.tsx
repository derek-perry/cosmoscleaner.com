      ...
      <main className="py-9 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="policy">
          ...
          <section id="privacypolicy" className="max-w-[1000px] text-left">
              ...
              <h2 id="user-data" className="mt-8 text-4xl font-bold">Game User Data</h2>
              ...
              <h2 id="transfers" className="mt-8 text-4xl font-bold">Business Transfers</h2>
              ...
              <p className="my-4 text-2xl">If you have any questions about this Privacy Policy, please contact Cosmos Cleaner via email at <LinkExternal className="break-all" href="mailto:contact@cosmoscleaner.com" title="Contact Cosmos Cleaner via Email at Contact@CosmosCleaner.com">Contact@CosmosCleaner.com</LinkExternal></p>
          </section>
        </article>
      </main>
