      ...
      <main className="max-md:pt-2 md:pt-9 pb-20 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="privacy">
          ...
          <section id="privacypolicy" className="max-w-[1000px] text-left">
            ...
            <p>It is Cosmos Cleaner’s policy to respect your privacy regarding any information Cosmos Cleaner may collect while viewing/using Cosmos Cleaner's website. This privacy policy applies to <LinkInternal href="" title="CosmosCleaner.com">CosmosCleaner.com</LinkInternal> (hereinafter, “the website”, “Cosmos Cleaner's website”). Cosmos Cleaner respects your privacy and is committed to protecting personally identifiable information you may provide Cosmos Cleaner through the website. Cosmos Cleaner has adopted this privacy policy (“privacy policy”) to explain what information may be collected in the website, how Cosmos Cleaner uses this information, and under what circumstances Cosmos Cleaner may disclose the information to third parties. This privacy policy applies only to information Cosmos Cleaner collects through the website and does not apply to the collection of information from other sources.</p>
            ...
            <p>Cosmos Cleaner may collect statistics about the behavior of users in the website. Cosmos Cleaner may display this information publicly or provide it to others. However, Cosmos Cleaner does not disclose your personally-identifying information.</p>
