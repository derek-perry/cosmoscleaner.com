      ...
      <main className="py-9 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="presskit">
          ...
          <section id="presskitcontent" className="max-w-[1000px] text-left">
              ...
              <p className="my-4 text-2xl">If you are writing about, sharing videos of, or streaming Cosmos Cleaner, thank you! Please use this press kit, any in-game content, and any website content (all with proper attribution where useful) in your publications, websites, streams, or videos whether commercial or non-commercial.</p>
              <p className="my-4 text-2xl">Use Cosmos Cleaner and its content (in-game content, the website, relevant information, relevant media, etc.) at your own risk. None of the developers, contributors, or anyone else connected with Cosmos Cleaner, in any way whatsoever, can be responsible for your use of the game, the website, and the information/media contained in or linked to/from the game and the website.</p>


              <h2 id="changes" className="mt-8 text-4xl font-bold">Press Kit Changes</h2>
              <p className="my-4 text-2xl">Although most changes are likely to be minor, Cosmos Cleaner may change this media/press kit from time to time, and in Cosmos Cleaner’s sole discretion. Cosmos Cleaner encourages users to frequently check this page for any changes to this media/press kit.</p>
