      ...
      <main className="max-md:pt-2 md:pt-9 pb-20 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="tosgame">
          ...
          <section id="termsofservicegame" className="max-w-[1000px] text-left">
            ...
            <p>Copyright © 2023-2024 Cosmos Cleaner™ and related design and composite marks are trademarks of Cosmos Cleaner owned and operated by Derek Perry. All rights reserved.</p>
