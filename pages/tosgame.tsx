...
const tosGamePage: NextPage = () => {
  return (
    <div className="text-cyan-900 min-h-screen flex flex-col items-center justify-center">
      <SiteHead title="Cosmos Cleaner Terms of Service" description="Cosmos Cleaner respects your privacy and your personal data. - Clean up space junk, upgrade your ship, and become the best cleaner in the cosmos!" url="tosgame" />

      <main className="max-md:pt-2 md:pt-9 pb-20 px-9 max-w-[1000px] w-full flex flex-1 flex-col items-center justify-center">
        <article id="tosgame">
          <section id="contentheader">
            <h1>Cosmos Cleaner Terms of Service</h1>
            <div className="flex flex-col gap-4 mt-4">
              <ButtonInternal href="" title="Go to the home/index page of CosmosCleaner.com"><p>Go to Homepage</p></ButtonInternal>
              <ButtonInternal href="tos" title="Go to the terms of service for the website and wiki for Cosmos Cleaner"><p>Website/Wiki TOS</p></ButtonInternal>
            </div>
          </section>
          ...
          <section id="termsofservice" className="max-w-[1000px] text-left">
            ...
            <ul className="pl-7 pb-2 flex flex-col list-disc">
              <li key="game"><LinkInternal className="inline-block" href="" title="Cosmos Cleaner Game"><p>Cosmos Cleaner Game</p></LinkInternal></li>
            </ul>
            ...
            <p>All information collected on the Services is subject to <LinkInternal href="privacygame" title="Privacy Policy">Privacy Policy</LinkInternal>. By using the Services you consent to all actions taken by us with respect to your information in compliance with the <LinkInternal href="privacygame" title="Privacy Policy">Privacy Policy</LinkInternal>.</p>
            ...
            <p><i>These terms of service was last updated on November 7, 2023. Visit the <LinkExternal href="https://github.com/derek-perry/cosmoscleaner.com" title="View CosmosCleaner.com by Derek Perry on GitHub">website files on GitHub</LinkExternal> for version history.</i></p>
